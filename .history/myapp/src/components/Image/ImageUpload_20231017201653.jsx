...
const ImageUpload = (props) => {
  ...
  return (
    <label
      className={`cursor-pointer flex items-center justify-center border border-dashed broder-black w-[400px] min-h-[400px] rounded-lg ${className} relative overflow-hidden group`}
    >
      {del && (
        <input
          type="file"
