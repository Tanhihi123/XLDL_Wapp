...
const Result = () => {
  return (
    <div className="py-14 px-6">
      <div className="w-full h-[500px] flex items-center justify-center border border-white rounded-xl relative inline-block overflow-hidden rounded-full p-[1px]">
        <div className="flex items-center justify-center gap-3 w-1/2 h-full ">
          ...
          <div className="h-full w-1/2 p-3">
              <img src="https://source.unsplash.com/random" alt="img" className="h-full w-full rounded-lg" />
          </div>
        </div>  
