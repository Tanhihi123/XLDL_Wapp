  ...
  return (
    <div className="py-14 px-6">
      <div className="w-full h-[500px] flex items-center justify-center border border-white relative overflow-hidden p-[1px] rounded-lg">
        ...
        <div className="inline-flex h-full w-full cursor-pointer items-center justify-center bg-[##1C1C24] px-3 py-1 text-sm font-medium text-white backdrop-blur-3xl">
