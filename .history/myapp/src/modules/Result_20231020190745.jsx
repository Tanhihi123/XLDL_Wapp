...
const Result = () => {
  return (
    <div className="py-14 px-6">
      <div className="w-full h-[500px] flex items-center justify-center border border-white relative overflow-hidden p-[1px] rounded-lg">
        <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)]" />
        <div className="inline-flex h-full w-full cursor-pointer items-center justify-center bg-[slate-950/90] px-3 py-1 text-sm font-medium text-white backdrop-blur-3xl">
